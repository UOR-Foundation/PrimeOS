...
use ccm_primitives::page::{binomial, inject_page, page_count, page_of};
...
fn main() {
    ...
    println!(
        "  128-bit word with bits 0,64,127 set has page: {}",
        page_of(&word128)
    );
    ...
    for popcount in 1..=3 {
        ...
        println!(
            "  For popcount={}, there are {} possible pages",
            popcount, total
        );
    ...
    println!(
        "  1024-bit word with bits 0,500,1023 set has page: {}",
        page
    );
