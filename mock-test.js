...
async function runTest() {
  ...
  console.log(`- Weights shape: [${parameters.weights[0].length}x${parameters.weights[0][0].length}]`);
  ...
  console.log(`- Synchronization result: ${syncResult ? "success" : "failure"}`);
  console.log(`- Last sync iteration: ${model.distributedState.lastSyncIteration}`);
  console.log(`- Synchronized iterations: ${model.distributedState.synchronizedIterations}`);
