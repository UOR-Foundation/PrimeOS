...
async function runIntegrationTests() {
  ...
  assertEqual(
    model.layers[0].inputSize,
    10,
    "First layer should have input size 10",
  );
  assertEqual(
    model.layers[0].outputSize,
    8,
    "First layer should have output size 8",
  );
  assertEqual(
    model.layers[1].inputSize,
    8,
    "Second layer should have input size 8",
  );
  assertEqual(
    model.layers[2].outputSize,
    3,
    "Third layer should have output size 3",
  );
  ...
  assertEqual(
    originalParams.weights.length,
    3,
    "Should have weights for 3 layers",
  );
  assertEqual(
    originalParams.biases.length,
    3,
    "Should have biases for 3 layers",
  );
  assertEqual(
    originalParams.layerConfig.length,
    3,
    "Should have config for 3 layers",
  );
  ...
  assertTrue(
    coherentResult,
    "Coherence check should succeed with valid parameters",
  );
  assertEqual(
