...
const tests = [
  ...
  // ManifoldSpace loading test
  {
    ...
    fn: function () {
      const {
        ManifoldSpace,
      } = require("../src/framework/base0/manifold-space.js");
  ...
  // ManifoldRelations loading test
  {
    ...
    fn: function () {
      ...
      if (
        ...
        typeof ManifoldRelations.connect !== "function"
      ) {
        throw new Error(
          "ManifoldRelations.connect method not properly defined",
        );
      }
    },
  },
  ...
  // GeodesicOperations loading test
  {
    ...
    fn: function () {
      ...
      if (
        ...
        typeof GeodesicOperations.computeGeodesic !== "function"
      ) {
        throw new Error(
          "GeodesicOperations.computeGeodesic method not properly defined",
        );
      }
    },
  },
  ...
  // TangentSpace loading test
  {
    ...
    fn: function () {
      ...
      if (
        ...
        typeof TangentSpaceOperations !== "object"
      ) {
      ...
      if (
        ...
        typeof TangentSpaceOperations.calculateTangentSpace !== "function"
      ) {
        throw new Error(
          "TangentSpaceOperations.calculateTangentSpace method not properly defined",
        );
      }
    },
  },
  ...
  // ManifoldVisualization loading test
  {
    ...
    fn: function () {
      ...
      if (
        ...
        typeof ManifoldVisualization.createVisualization !== "function"
      ) {
        throw new Error(
          "ManifoldVisualization.createVisualization method not properly defined",
        );
      }
    },
  },
  ...
  // ManifoldTransformations loading test
  {
    ...
    fn: function () {
      ...
      if (
        ...
        typeof ManifoldTransformations !== "object"
      ) {
      ...
      if (
        ...
        typeof ManifoldTransformations.alignWith !== "function"
      ) {
        throw new Error(
          "ManifoldTransformations.alignWith method not properly defined",
        );
      }
    },
  },
  ...
  // Combined ManifoldOperations backwards compatibility test
  {
    ...
    fn: function () {
      ...
      for (const method of requiredMethods) {
        if (
          !ManifoldOperations[method] ||
          typeof ManifoldOperations[method] !== "function"
        ) {
          throw new Error(
            `ManifoldOperations.${method} method not properly defined or accessible`,
          );
        }
      }
      ...
      for (const namespace of requiredNamespaces) {
        if (
          !ManifoldOperations[namespace] ||
          typeof ManifoldOperations[namespace] !== "object"
        ) {
          throw new Error(
            `ManifoldOperations.${namespace} namespace not properly defined`,
          );
        }
      }
    },
  ...
  // Integration test with simple manifold operations
  {
    ...
    fn: function () {
      ...
      const relation = ManifoldOperations.connect(
        manifoldA,
        manifoldB,
        "connected",
      );
      ...
      if (
        relation.type !== "connected" ||
        relation.sourceId !== "manifold_a" ||
        relation.targetId !== "manifold_b"
      ) {
      ...
      if (visualization.id !== "manifold_a") {
        throw new Error(
          "ManifoldOperations.createVisualization not working properly",
        );
      }
    },
  },
