...
describe('Storage Adapters', () => {
  ...
  describe('Matrix Adapter', () => {
    ...
    beforeEach(async () => {
      ...
      matrixAdapter = await Prime.Storage.createMatrixAdapter(storageManager, id);
    });
  ...
  describe('Swappable Matrix', () => {
    ...
    beforeEach(async () => {
      ...
      swappableMatrix = await Prime.Storage.createSwappableMatrix(storageManager, id, {
  ...
  describe('Virtual Array', () => {
    ...
    test('should persist changes', async () => {
      ...
      const newArray = await Prime.Storage.createVirtualArray(
        storageManager,
        {
          id: virtualArray.id,
          length: arraySize,
