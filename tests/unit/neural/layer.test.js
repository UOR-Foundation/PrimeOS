...
Object.keys(require.cache).forEach(key => {
  if (key.includes('neural') || key.includes('Prime')) {
    delete require.cache[key];
  }
});

// Import the consolidated neural module
const Prime = require("../../../src/neural.js");
const { Assertions } = require("../../utils");

// Verify required objects are available
if (!Prime || !Prime.Neural || !Prime.Neural.Layer) {
  throw new Error("Neural module not properly initialized");
}

// Log diagnostic information
console.log("Neural layer testing setup with actual implementation");
