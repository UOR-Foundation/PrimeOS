...
describe("Neural Optimization", () => {
  ...
  describe("Coherence Adam Optimizer", () => {
    ...
    test("should handle extremely small gradients appropriately", () => {
      ...
      const updatedParams = optimizer.update(
        params,
        tinyGradients,
        coherenceFn,
      );
      ...
      expect(
        Math.abs(updatedParams.weights[0][0] - params.weights[0][0]),
      ).toBeLessThan(1e-10);
    });
  });
  ...
  describe("Optimizer Factory", () => {
    test("should create optimizer from config", () => {
      ...
      expect(
        sgdOptimizer instanceof Prime.Neural.Optimization.CoherenceSGD,
      ).toBe(true);
      ...
      const adamOptimizer =
        Prime.Neural.Optimization.createOptimizer(adamConfig);
      expect(
        adamOptimizer instanceof Prime.Neural.Optimization.CoherenceAdam,
      ).toBe(true);
    ...
    test("should create optimizer with default values when not specified", () => {
      ...
      const optimizer =
        Prime.Neural.Optimization.createOptimizer(minimalConfig);
      expect(optimizer instanceof Prime.Neural.Optimization.CoherenceSGD).toBe(
        true,
      );
