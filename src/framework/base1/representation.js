...
const RepresentationModel = {
  ...
  create: function(config = {}) {
    return {
      ...
      security: {
        allowedHtmlTags: config.allowedHtmlTags || ['div', 'span', 'p', 'ul', 'ol', 'li', 'dl', 'dt', 'dd', 'table', 'tr', 'td', 'th', 'thead', 'tbody', 'tfoot', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'pre', 'code', 'a', 'img', 'time'],
        allowedHtmlAttributes: config.allowedHtmlAttributes || ['id', 'class', 'href', 'src', 'alt', 'title', 'datetime', 'width', 'height', 'target']
      },
        ...
        if (this._base0 && this._base0.representation) {
          ...
          if (this._base0.representation.formats && this._base0.representation.formats[format]) {
            try {
              ...
              Prime.Logger.error(`Error using Base0 representation for ${format}:`, error);
          ...
          if (format === 'string') {
            if (typeof object === 'object' && object !== null) {
              ...
              try {
                ...
                return Object.prototype.toString.call(object) + ' ' + Object.keys(object).join(', ');
              }
            }
        ...
        try {
          switch (format) {
            ...
            case 'csv':
              ...
              throw new Prime.InvalidOperationError('CSV format requires an array input');
          ...
          Prime.Logger.error(`Error presenting object in ${format} format:`, error);
      ...
      _presentAsJson: function(object, options = {}) {
        ...
        try {
          ...
          return JSON.stringify(object, circularReplacer(), options.pretty ? 2 : undefined);
        } catch (error) {
          ...
          return JSON.stringify(safeObject(object), null, options.pretty ? 2 : undefined);
        }
      },
      ...
      _presentAsHtml: function(object, options = {}) {
        ...
        const objectToHtml = (obj, depth = 0) => {
          // Check depth limit
          if (depth >= maxDepth) {
            return this._createSafeHtml('div', this._escapeHtml(options.depthExceededPlaceholder || '[Object]'), {
          ...
          if (obj === null) {
            return this._createSafeHtml('span', this._escapeHtml(options.nullPlaceholder || 'null'), {
              class: classes.null || 'null-value'
            });
          }

          if (obj === undefined) {
            return this._createSafeHtml('span', this._escapeHtml(options.undefinedPlaceholder || 'undefined'), {
          ...
          if (Array.isArray(obj)) {
            ...
            for (let i = 0; i < obj.length; i++) {
              const item = obj[i];
              itemsHtml += this._createSafeHtml('li', objectToHtml(item, depth + 1));
            }
          ...
          // Handle dates
          if (obj instanceof Date) {
            return this._createSafeHtml('time', this._escapeHtml(obj.toISOString()), {
          ...
          for (const [key, value] of Object.entries(obj)) {
            ...
            const valueHtml = this._createSafeHtml('dd', objectToHtml(value, depth + 1), {
        ...
        const createXmlElement = (name, value, attributes = {}) => {
          ...
          if (value === null || value === undefined) {
            ...
            if (Array.isArray(value)) {
              ...
              childElements = value.map(item => createXmlElement('item', item)).join('');
