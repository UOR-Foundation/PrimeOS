...
class DistributedTraining {
  ...
  constructor(options = {}) {
    // Components
    this.parameterServer = new Prime.distributed.training.ParameterServer(options.parameterServer);
    this.gradientAggregator = new Prime.distributed.training.GradientAggregator(options.gradientAggregator);
    this.modelPartitioner = new Prime.distributed.training.ModelPartitioner(options.modelPartitioner);
    this.faultTolerance = new Prime.distributed.training.FaultTolerance(options.faultTolerance);
